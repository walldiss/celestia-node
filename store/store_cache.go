...
// not be able to write to it. Making parent store cache and CachedStore cache independent for
// writes.
...
// WithCache wraps store with extra layer of cache. Created caching layer will have read access to
// original store cache and will duplicate it's content. It updates parent store cache, to allow it
// to read from additionally created cache layer.
